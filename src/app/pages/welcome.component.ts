  ...
  template: `
    <mat-card>
      ...
      <mat-card-content>
        ...
        <h2>Key Links</h2>
        <p><a routerLink="/data/all-potentially-relevant-ai-policies-reviewed">Table A. All Potentially Relevant AI Policies Reviewed</a></p>
        <p><a routerLink="/data/policy-analysis">Table B. Policy Analysis Table</a></p>
